  ...
  const handleSubmit = async (values, { resetForm }) => {
    try {
      const newEmployee = await axios.post(
        `${backendLocation}/admin/create/training`,
        values,
        {
          headers: {
    ...
    <div className="login">
      ...
      <div>
        ...
        <Formik
          ...
          validationSchema={validateTraining}
          ...
          {({ isSubmitting }) => (
            <Form>
              ...
              <div className="d-grid mt-3">
                ...
                <ErrorMessage name="exang" component="div" className="error" />
              </div>
              ...
              <div className="d-grid mt-3">
                ...
                <ErrorMessage name="slope" component="div" className="error" />
              </div>
              ...
              <div className="d-grid mt-3">
                ...
                <ErrorMessage name="ca" component="div" className="error" />
              </div>

              <div className="d-grid mt-3">
                <label htmlFor="thal">Thalassemia:</label>
                <Field type="number" name="thal" />
                <ErrorMessage name="thal" component="div" className="error" />
              </div>

              <div className="d-grid mt-3">
                <label htmlFor="bp">Blood Pressure:</label>
                <Field type="number" name="bp" />
                <ErrorMessage name="bp" component="div" className="error" />
              </div>
